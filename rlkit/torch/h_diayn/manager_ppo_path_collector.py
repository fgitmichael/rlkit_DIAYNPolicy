...
from rlkit.torch.h_diayn.h_diayn_rollout_functions import rollout, dirichlet_rollout
...
class DirichletManagerPPOMdpPathCollector(ManagerPPOMdpPathCollector):
    def collect_new_paths(
            self,
            max_path_length,
            num_steps,
